...
public class CharacterMotor : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        tr = transform;
		NotificationCenter.DefaultCenter.AddObserver(this, "Jump");
    }
    ...
    void OnControllerColliderHit(ControllerColliderHit hit)
    {
        ...
        if (hit.rigidbody){
			float weight = this.gameObject.rigidbody.mass;		
			hit.rigidbody.AddForceAtPosition(-Vector3.up * weight, hit.point,ForceMode.Force);
		}
    }
