...
public class NotificationCenter : MonoBehaviour
{
    ...
    public void AddObserver(Component observer, string name, Component sender)
    {
        ...
        if (string.IsNullOrEmpty(name)) { Debug.Log("Notification Center: Null name specified for notification in AddObserver."); return; }
    ...
    public void PostNotification(Notification aNotification)
    {
        ...
        {
            Debug.Log("Notification Center: Null name sent to PostNotification.");
            return;
        }
        ...
        if (notifyList == null)
        {
            Debug.Log("Notification Center: Notify list not found in PostNotification: " + aNotification.name);
            return;
        }
